...
_buildUpcomingAppointmentCard(
 ...
 Widget _buildUpcomingAppointmentCard({
  ...
  Future<void> _selectConsultationDate(BuildContext context, String counselorName) async {
    ...
    if (picked != null) {
      ...
      _showScheduleConfirmation(context, counselorName, formattedDate);
    }
  }

  // Show schedule confirmation dialog
 void _showScheduleConfirmation(BuildContext context, String counselorName, String selectedDate) {
  showDialog(
    context: context,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Subtitle
              Text(
                'Pastikan detail konsultasi Anda sudah benar',
                style: TextStyle(
                  fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        _showSuccessMessage(context, counselorName, selectedDate);
                      },
  ...
  void _showSuccessMessage(BuildContext context, String counselorName, String selectedDate) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Jadwal konsultasi dengan $counselorName berhasil dibuat untuk tanggal $selectedDate'),
        backgroundColor: Theme.of(context).colorScheme.primary,
